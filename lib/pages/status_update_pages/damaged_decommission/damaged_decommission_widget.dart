                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'l0virjco' /* Scan or enter Serial/SSCC */,
                                        ),
                    ...
                    children: [
                      ...
                      FlutterFlowDropDown<String>(
                        ...
                        optionLabels: [
                          ...
                          FFLocalizations.of(context).getText(
                            '0gkrvbs5' /* 2D Matrix not readable  */,
                          ),
                          FFLocalizations.of(context).getText(
                            'k9l8l56p' /* Smashed */,
                          ),
                          FFLocalizations.of(context).getText(
                            'fnun106h' /* Damage due To liquid spill  */,
                          ),
                          FFLocalizations.of(context).getText(
                            'zpk0w0kt' /* Other */,
                          )
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, itemInListIndex) {
                                      ...
                                      return ScannedSerialsToDecommissionWidget(
                                        key: Key(
                                            'Keyr0p_${itemInListIndex}_of_${itemInList.length}'),
